...
\paragraph{28 de janeiro a 17 de março de 2010}
...
eventualidade. Será que a família até hoje não sacou que quem
...
perceber na hora e ser medicada na hora. Eu sou craque, já
...
\paragraph{14 de fevereiro de 2010}
...
me controlar. A~luzinha acendeu, eu tenho que me esforçar muito 
agora para discriminar o que é ``irritação maníaca'' e o
...
ninguém que eu corro esse risco! Não vai eclodir nenhuma crise!
...
\item
  \versal{CAMINHAR}. \versal{APROVEITAR} \versal{O} \versal{SOL} \versal{DA} \versal{MANHÃ}. O~Del porto já me falou umas 500
...
\item
  \versal{UMBANDA}, \versal{JOHREI}, \versal{MEDITAÇÃO}: não, não e não. Acabam me
...
\paragraph{22 de fevereiro de 2010}
...
\versal{REMÉDIOS}, \versal{ESPECIALMENTE} \versal{O} \versal{SONO} \versal{E} \versal{A} \versal{TOTAL} \versal{FALTA} \versal{DE} \versal{ENERGIA} \versal{E} \versal{A} \versal{GORDURA},
...
por telefone, e eu tinha tido uma consulta na véspera, que
...
\paragraph{24 de fevereiro de 2010}
...
elas usaram meus cremes. Eu odeio ser invadida. Eu fui superinvadida 
enquanto elas estiveram aqui, sempre fazendo inalteráveis seu
tricô ou seu crochê.
...
férrea'' quando a gente \versal{ESTÁ} \versal{BEM}, \versal{ESTÁ} \versal{ESTÁVEL}. A~gente tem, no
...
urinária por causa do lítio que já dura oito meses. Uma porra!
...
janeiro de 1996. Eu percebi que estava entrando de novo numa
...
noite a Juce teve um ataque agressivo comigo, foi supermalcriada.
...
da Cida, o autoritarismo, a rigidez absoluta, o supercontrole de cada
...
com a Preta e os acompanhantes terapêuticos (\versal{AT}) ``antigos'', aquela moçada
...
Se eu tenho um anjo da guarda, ele se chama Preta. Ela foi
...
Carbolitium e 1250mg de Depakote é bastante. Eu sempre bebi, mesmo tomando
...
grande vazio porque acredito na função educativa deste
...
Imagino que o Del Porto tenha dado um antidepressivo e eu comecei
...
ocorre depois mostra que você estava certa.
...
camisetas pra vender, montei um ateliê na garagem de casa. Deu supercerto. 
Levei as camisetas numa loja chamada Arte Assinada, na rua Oscar
...
Fui para São Sebastião e lá enlouqueci de vez. A~casa virou um
...
prazer em dar aula, isso é muito visível, e ele é superdidático.
...
fantástico é que ele aceita, acolhe a expressão individual de
...
\versal{FINALMENTE} \versal{SAÍ} \versal{DA} \versal{TUMBA} \versal{ONDE} \versal{FIQUEI} \versal{POR} \versal{DOIS} \versal{ANOS} \versal{CHEIA} \versal{DE} \versal{TERRA} \versal{E} \versal{DE}
\versal{BICHOS} \versal{ME} \versal{COMENDO}!

Depois que deixaram claro que não era para eu ir para a fazenda do
Fernão e da Soninha porque eu poderia ter um surto lá, todo mundo
sumiu. Eles só queriam se livrar de mim. O~Zeca. O~Paulinho, a
...
Vanderleia. ``\versal{ATENÇÃO} \versal{PARA} \versal{O} \versal{REFRÃO}, \versal{TUDO} \versal{É} \versal{DIVINO}, \versal{MARAVILHOSO}!''
...
e não aquele vestido de \emph{shantung} ou a calça \emph{Lee} que eu queria
...
escrevi… Perdi a hora, saco! Eu me programei de novo para
...
muito difícil ir à analise, ao Del Porto, à farmácia, ao supermercado. 
É~nesses momentos que eles me ajudam muito a manter o meu
...
consigo sair sozinha. Nesses momentos eles me ajudam muito. Eu
...
\versal{O} \versal{DEL} \versal{PORTO}, \versal{ELE} \versal{SÓ} \versal{FURA} \versal{COMIGO}! \versal{ELE} \versal{SÓ} \versal{FURA} \versal{COMIGO}!
...
``\versal{TÔ} \versal{FORA}'', eu pensei.
...
no início caminhava dez minutos por dia, só tinha energia para
...
\versal{E} \versal{ISSO} \versal{É} \versal{UM} \versal{SACO}!

\versal{QUE} \versal{VONTADE} \versal{DE} \versal{SER} \versal{NORMAL}!
...
\versal{MENOS} \versal{DESGASTE}…
 ...
 \paragraph{28 de março de 2010}


\versal{DOMINGO}

\versal{A} \versal{SOLIDÃO} é uma coisa tão pesada e tão fodida que ela mata

\versal{O} \versal{DESEJO} \versal{DE} \versal{LER},

\versal{O} \versal{DESEJO} \versal{DE} \versal{DESENHAR},

\versal{O} \versal{DESEJO} \versal{DE} \versal{PINTAR},
...
\versal{A} \versal{GENTE} \versal{ACABA} \versal{VENDO} \versal{O} \versal{FAUSTÃO} \versal{PARA} \versal{NÃO} \versal{SENTIR} \versal{TANTA} \versal{SOLIDÃO}!
...
tintas Liquetex… Liguei a \versal{TV} no Faustão e peguei uma Coca"-Cola. A~televisão pelo menos tem voz de gente, você ouve gente e vê
gente!
...
tudo isso é \versal{TER} \versal{RECUPERADO} \versal{A} \versal{CAPACIDADE} \versal{DE} \versal{SENTIR} \versal{PRAZER} \versal{NAS} \versal{PEQUENAS}
\versal{COISAS} \versal{DO} \versal{DIA} \versal{A} \versal{DIA}, \versal{PRAZER}, \versal{PRAZER}, \versal{PRAZER}!
...
\versal{ABERTURA} \versal{E} \versal{TOLERÂNCIA} e liguei para a Cecília. Ela é extremamente
...
Estou cansada de saber que só eu posso detectar os sintomas e
...
que ``para um bipolar é importante caminhar e pegar o sol da manhã''?
Ajuda na
...
\versal{MUITO}. \versal{E}~\versal{NOS} \versal{OUTROS} \versal{ASPECTOS} \versal{TAMBÉM}…
...
medo. \versal{EU} \versal{NÃO} \versal{CONSEGUIA} \versal{PENSAR}, \versal{EU} \versal{NÃO} \versal{CONSEGUIA} \versal{REVER} \versal{MEU} \versal{TRABALHO} \versal{E}
\versal{FAZER} \versal{UMA} \versal{SÍNTESE}. \versal{O}~\versal{TRABALHO} \versal{DE} \versal{UMA} \versal{VIDA}! \versal{O} \versal{TRABALHO} \versal{MAIS} \versal{IMPORTANTE} \versal{DA}
...
vinha com uma proposta superestimulante. Estou lembrando agora dela,
...
O~curso foi maravilhoso e inesquecível, deu supercerto.
...
supereficiente! Reparei que tinha uma loja de móveis de vime do
...
\versal{A} \versal{MANIA} \versal{É} \versal{UM} \versal{RISCO} \versal{TOTAL}, \versal{MUITAS} \versal{VEZES} \versal{A} \versal{MANIA} \versal{É} \versal{UM} \versal{RISCO} \versal{DE} \versal{VIDA}, \versal{DE}
...
eram sempre iguais, repetidas, e faziam um desenho em \versal{Y}. Eu não
...
Quando o Ernesto e o Milan ligaram para lá, eu fiquei superfeliz. Eu
...
\versal{ET} naquele aquário de madames. Só tinha uma moça alternativa, mas ela
não era muito dada. As madames trabalhavam muito, e seus trabalhos
cresciam. Eu me sentia um \versal{ET}, porque só pintava paisagem, todo mundo
...
orienta a partir de sua expressão pessoal, ela não impõe um modelo. 
A~Sara também é uma grande artista, já expôs quatro vezes no Japão.
...
festas, que naquela época eram muitas, todo sábado tinha festa. 
O~Gaiarsa ficava me esperando, deitado no sofá. Agora percebo que isso não
...
\paragraph{2 de maio de 2010}


Em agosto de 1973 comecei a fazer um estágio na Oficina de Arte do Nível
\versal{I} do Vera Cruz, o Verinha, como era chamado. Até então eu contava com
...
professora de Arte no Nível \versal{II} do Vera Cruz, por oito anos na Pinacoteca
...
meu trabalho tem verdade. Acho que foi disso que eu mais gostei. 
A~verdade no trabalho de arte, para mim, é essencial. A~verdade na vida é
...
\item
  ...
  (antropóloga); 
\item
  José Celso Martinez Corrêa (diretor e artista de
  teatro): ``Paixão palpável''; \\José Miguel Wisnik (professor de literatura e músico): ``Paixão
...
Interamericano de Desenvolvimento, Washington, \versal{DC} -- \versal{EUA}. Emanoel
...
\paragraph{25 de setembro de 2010}
...
\paragraph{10 de outubro de 2010}
...
\paragraph{26 de outubro de 2010}


\subsection{\emph{Na Granja Julieta}}

Eles conseguiram e conseguiram. Fui internada hoje às 16h00. Eu
...
situação, superansiosos, e é terrível porque essa ansiedade familiar me
...
Foi o Del Porto quem tomou essa decisão, a pedido do Fernão, e
ligou para mim para dizer que eu seria internada porque seria melhor
para mim nesses dias de final de ano. Parece que todas as famílias
resistem a ter por perto a presença do parente bipolar, seja no meio do
ano, no Carnaval, no Natal ou no \emph{Réveillon}. A~não ser quando
...
Tinha vezes que eu sentia uma vontade enorme, era um
impulso muito forte de me suicidar. Outras vezes eu tinha o
pensamento obsessivo do suicídio. Eu planejava tudo: como
...
gente. Me senti uma total leprosa, alguém que ninguém quer chegar
...
Bipolar do Humor'', nome que disfarça a gravidade e a tragicidade
da doença.
...
clínica tem. Eu adoro contemplar as carpas nadando, revoluteando
...
\paragraph{27 de dezembro de 2010}
...
Eu vi em um mural de um consultório médico esta frase anônima: ``A
...
Voltando à generosidade enorme do Rogério: durante um ano e meio,
depois da mania de 2008, ele me telefonava todas as noites para saber se
eu estava bem. Ele fazia uma visita de irmão e de médico.
...
esteve muito presente, e isso é claro que faz a maior diferença
...
a Sara, com quem bati um bom papo. Eu adoro a Sara, me entendo superbem
...
presas, ou melhor, as ``loucas''. Era um hospital só para mulheres.
Todas elas tinham os cabelos cortados, bem curtinhos, e usavam aventais
xadrezinhos de branco e azul, ou de branco e vermelho, conforme o
...
perguntando e perguntando. Invasão total, sem a menor cerimônia.
O~fascínio dos ``sãos'' pelos ``loucos'' se explicitava
...
\paragraph{31 de dezembro de 2010}
...
vestidão. Estou com as guias que fiz na \versal{TO}, que são bem bonitas, bem
vistosas. Uma delas traz Iemanjá, Preto Velho, Cabocla Guaciara e
Rosa; a outra, Ogum, Cabocla Guaciara e Preto Velho. Azuis,
verdes e marrons lindos. Nas contas.

Eu fui até a \versal{TO}, com o maior preconceito e daí, de repente, adorei fazer
...
lindo, supersóbrio, em tons de bege, que combina com a Nanda. Estou
...
\paragraph{1 de janeiro de 2011}
...
\paragraph{2 de janeiro de 2011}
...
problema de pacientes com anorexia grave!\textbf{} Dá para
...
metros, supercolorida e enfeitada. Está linda e é o maior astral. Na
...
Uma parte dos internos se constitui de uma moçada viciada em drogas.
...
rejeição por mim quando entrei na \versal{TO}, e eles pararam de conversar,
...
\paragraph{3 de janeiro de 2011}
...
de estar é supertrabalhado com gesso, formando figuras muito bonitas
...
\paragraph{4 de janeiro de 2011}
...
E pensar que passei anos me culpando porque dormia demais…
e era tudo efeito colateral de remédio! Ô sofrimento!… Não
...
pomba"-gira. A~cada dia ela usa uma roupa superproduzida, vermelha,
...
preto. Ela tem o corpo inteirinho tatuado, não sobra espaço
...
recebi foi da Preta, superafetiva e carinhosa. Depois ligaram a
Soninha, que enviou de presente um par de brincos lindos, ovalados,
compridos, em ouro e madrepérola, e ligaram também a Sara, o
Daniel, a Fátima, a Bete etc. Minha memória recente
...
\versal{TO}, ofereceu um panetone à guisa de bolo, e eu ofereci o primeiro
pedaço para o Paulo, que ficou roxo de timidez.

De manhã, no dia 04/01, quando eu entrei na \versal{TO}, estava tocando, a
...
Janis Joplin cantando \emph{Cry baby}! Eu morri de emoção. Eu
...
trabalhar muito bem no meio da zoeira que é aquela sala da \versal{TO}, onde
...
\paragraph{14 de janeiro de 2011}
...
\paragraph{17 de janeiro de 2011}
...
Ainda fico um pouco impaciente com as pessoas e sou um pouco
ríspida. Ou muito.
...
minha mediunidade na minha pintura e na minha cerâmica. Mas não
...
acompanhantes, estou superexausta nesse sentido porque ter um
...
completamente estragadas. Eu consegui comprar lâmpadas, e o
...
rosas que coloquei na sala. Senti perto de mim a presença boa da
...
presença boa, que tem um encantamento. Presença que o
Sylvio chama de ``radiosa''.




\paragraph{23 de janeiro de 2011}
...
rainha naquela cadeira enorme. Parecia, não: ``ela é uma rainha''.
Eu contei para ela que há um mês ou 20 dias, eu não sei, eu tenho
sentido a presença dela e do Saulo, me orientando para desmanchar
...
um dia na semana para ir à Messiânica e me dedicar a ministrar
...
comigo. Eles me dão chão. Eu nunca conheci na vida duas pessoas
...
saí da clínica, em 2008, me ligou diariamente durante um ano e
...
por mim, que de vez em quando conseguem me tirar de casa para ir
ao cinema ou a uma exposição.




\paragraph{9 de fevereiro de 2011}
...
acordei melhor, consegui tomar banho, almoçar e ir ao banco fazer
...
confundir de novo ``empregada'' com ``amiga''. Dar limites
...
poucos foi me dando uma tristeza profunda, profundíssima, um
...
agora! Chega de crises! Chega de sofrer, sofrer e sofrer! Vida
nova!




\paragraph{16 de junho de 2011}
...
Na consulta de segunda eu fiquei arrasada quando o Del Porto
...
desesperada, me sentindo absolutamente sem saída. A única
...
me fez muita companhia. Eu me sentia superbem quando estava com ela.
...
ficam superexcitados com essa possibilidade… Até hoje eu não
...
claramente que \versal{NÃO} \versal{QUERIA} \versal{QUE} \versal{NINGUÉM} \versal{MAIS} \versal{MEXESSE} \versal{COM} \versal{O} \versal{MEU} \versal{CORPO} \versal{E} \versal{COM}
\versal{A} \versal{MINHA} \versal{CABEÇA}. Fui muito firme e direta ao falar isso, e ele ficou
surpreso e \versal{EMBASBACADO}. Como eu estava relativamente bem ao ter essa
consulta, apesar da depressão, pude ter uma postura ativa, \versal{CLARA} \versal{E}
...
tratamento tradicional, que é uma combinação de antidepressivos: \versal{PONDERA} e \versal{WELLBUTRIN}, mais 2,5mg de \versal{ZYPREXA} e 1000mg de \versal{DEPAKOTE} e 20mg de
...
meses: abril, maio e junho. Tive, no entanto, que segurar duas pequenas
ameaças de mania nesse período. Como percebi a tempo, liguei para o Del
...
arregalados, como se eu fosse um \versal{ET}, que baixou naquele almoço, naquele
...
ao máximo essa fase boa. Tenho pintado trabalhos enormes de 2m \versal{X} 1m (na
...
Fiquei superfeliz! Exultei! Ele disse que agora preciso de uma
galeria para expor.
...
Aprendi a fotografar sozinha pelo celular. Nas próximas aulas
...
continuar muito atenta ao meu processo.




\paragraph{18 de novembro de 2011}
...
loja fantástica, Mundo do Enxoval, fez uma liquidação e eu aproveitei.
...
formados na \versal{USP}, mas aos poucos ele começou a gostar da moçada. 
...
senti um pouco um \versal{ET}, porque o Instituto Tomie Ohtake estava lotado de
...
superansioso com o meu silêncio, com a minha postura. Nesses momentos,
...
\paragraph{28 de novembro de 2011}
...
era superperto da \versal{FAAP}. Tomava um lanche rápido e às 19h00 ia a pé para
...
\item
  ...
  \end{itemize}
\end{itemize}
``Fazer e, em fazendo, fazer"-se'', como dizia o Sartre.
...
\nobreak\begin{flushright}\emph{Maria Regina Barros Sawaya},\end{flushright}
\nobreak\begin{flushright}\emph{Professora, Coordenadora, Assessora da Área de Arte da Escola Vera
Cruz, Nível \versal{II}}\end{flushright}
\nobreak\begin{flushright}\emph{Professora de crianças e adultos na Pinacoteca do Estado}\end{flushright}


\end{quote}


\paragraph{4 de janeiro de 2012}
...
tecia algum comentário sobre a Tuxa, em geral era assim:
...
\paragraph{7 de janeiro de 2012}
...
\paragraph{10 de janeiro de 2012}
...
quê. Ele é um ótimo ouvinte. Superatento e supersensível.




\paragraph{12 de janeiro de 2012}
...
\paragraph{26 de janeiro de 2012}
...
libanesa, libanesíssima! Nada como ter ``sangue novo''. Eu sempre
...
aqui na fazenda. Ele é o mestre do enquadramento. Não tem outro. Não tem
...
digna filha do Dr. Sawaya, mesmo… Ainda mais livros de arte.
...
deuses. Elas são perfeitas. Superperfeitas. Delicadas, cortadas
...
\paragraph{28 de janeiro de 2012}
...
mamãe. E~fui, fui mesmo. Afinal, eu tinha cara de turca. Talvez ela me
...
Quando eu era criança, eu acho que desejei muito conseguir, pelo menos,
...
na praça Benedito Calixto e outros, numa loja incrível que chama \versal{L.S.}, e
fica na rua João Cachoeira. O~problema é que tudo que tem na \versal{L.S.}, é
...
vitrine da \versal{L.S.}, e fico babando, mas não paro e não entro. Ainda bem que
...
\paragraph{29 de janeiro de 2012}
...
tinha muita fé. Era supercatólica e morava em frente à Igreja São José,
...
Shopping Iguatemi. Lá tem a Erica's e a Sinhá, com alguns modelos
...
\paragraph{31 de janeiro de 2012}
...
Há pouco tempo, inclusive, eu fiz um ebó e um buri, tudo na mesma noite,
...
\paragraph{5 de fevereiro de 2012}
...
remédios que o médico receitar, exatamente no horário\textbf{} em
...
\emph{Uma mente inquieta}, de Kay Redfield Jamisom, Martins Fontes, 1996.
...
suas experiências com a doença e publicar. A~gente poderia formar uma imensa 
rede de ajuda. Um ajuda outro, que ajuda outro, que ajuda outro.
...
Stilnox, Dormonid, Lexotam da vida e seus terríveis efeitos
...
\paragraph{\versal{MEMÓRIA,} 6 de fevereiro de 2012}
...
\paragraph{\versal{ATRASO,} 6 de fevereiro de 2012}
...
O~meu cabelo ainda vai ficar caindo por falta do remédio. Só
...
\paragraph{\versal{DORES}, 6 de fevereiro de 2012}
...
ebó e de um buri, pipoca, pétalas de rosas brancas e alecrim, arruda e
...
madrugada do velório, ele escreveu um texto lindo sobre a Tuxa.
...
\paragraph{8 de fevereiro de 2012}
...
\paragraph{14 de fevereiro de 2012}
...
\item
  ...
  bordadas em estilo indiano. Meu sofá está superconfortável e alegre
  agora.
\end{itemize}
...
\paragraph{16 de fevereiro de 2012}
...
fantásticas\textbf{} para tampar os olhos. Influência veneziana
...
tela cujo fundo é preto. Deve ter uns 30cm \versal{X} 40cm. É~um trabalho
...
\paragraph{17 de fevereiro de 2012}
...
Preto / Encanto da Alegria / \versal{MARACATU} \versal{B.S.}\,\versal{CRUZEIRO} \versal{DO} \versal{FORTE}.
...
\paragraph{18 de fevereiro de 2012}
...
O Rogério ligou. Ele tá superpreocupado porque estou sozinha aqui.
...
\paragraph{20 de fevereiro de 2012}
...
barriga da perna estão sendo ``\versal{ALFINETADAS} \versal{O} \versal{TEMPO} \versal{TODO}''. Dói muito,
...
integridade e \versal{FÉ}. \versal{MUITA} \versal{FÉ}. Coragem. Vida, com \versal{V} maiúsculo,
segurando com coragem e ardor aquela roupagem linda e
pesadíssima.
...
\paragraph{21 de fevereiro de 2012}
...
que eu adorei, e Calhetas, que tem uma vista deslumbrante. No
...
\paragraph{23 de fevereiro de 2012}
...
Eu, a Polyana e a amiga estávamos falando sobre empregadas. A~mineira logo se enturmou no papo. Mil observações. Mil palpites, mil conclusões.
...
melhores do Brasil, se não for o melhor, fiquei superfeliz com a
...
\paragraph{24 de fevereiro de 2012}
...
\paragraph{25 de fevereiro de 2012}
...
\paragraph{27 de maio de 2012}


Cheguei de volta a São Paulo dia 25 de fevereiro. O~Ricardo (\versal{AT}) foi me
buscar no aeroporto como eu tinha pedido. Ele é um santo, superdisponível e generoso no seu trabalho. Fomos comer uma \emph{pizza} na
...
café na cozinha é o primeiro sintoma. Começar a me encantar com
...
tiver outras manias avassaladoras. Acho que nessas horas o apoio
...
culpa. Ela é doente. Ela tem uma doença grave. Às vezes,
gravíssima!
...
\paragraph{18 de agosto de 2012}
...
\paragraph{23 de setembro de 2012}
...
pessoa e depois outra. Era tudo o que eu gostaria de ouvir de alguém. 
É~exatamente assim que eu me sinto depois de ver uma boa exposição. Esse
comentário dela foi um grande presente.

Fiquei muito feliz com a presença do Megumi e da Naoko. Eles admiram
muito o meu trabalho e me dão a maior força. O~Jardim chegou supercedo
...
não ver a Soninha e o Fernão, que são sempre superpontuais, mas, lá
...
superemocionada, de cara, ao ver os meus desenhos através dos vidros,
...
Texto do catálogo da exposição ``Paisagens Interiores'':
...
\medskip{} 
\nobreak\begin{flushright}\emph{Oscar D'Ambrosio}\end{flushright}

\nobreak\begin{flushright}\emph{Doutorando em Educação, Arte e História da Cultura na Universidade
...
\paragraph{5 de dezembro de 2012}
...
com a minha clínica geral e, ao me pesar, fiquei superdecepcionada.
