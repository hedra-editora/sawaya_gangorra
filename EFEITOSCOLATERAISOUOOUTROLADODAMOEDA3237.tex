...
altos brados, \versal{SATISFACTION}, com os Rolling Stones. Nem acreditei,
...
``\versal{FORA} \versal{DAS} \versal{CRISES}, \versal{VIDA} \versal{NORMAL}''. 
...
\item
  ...
  \end{itemize}
\end{itemize}
``\versal{FAZER} \versal{E}, \versal{EM} \versal{FAZENDO}, \versal{FAZER}"-\versal{SE}'', como dizia o Sartre.
